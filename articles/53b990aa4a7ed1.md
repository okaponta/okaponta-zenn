...
なるほど、こうやって列挙してみると何をヘッダーに設定すべきかなんとなく分かってきたような気がします。
...
メタ情報であるかどうかが大事な観点な気がします。
普通に業務で使うようなデータであれば、ボディーに含めるべきですがシャーディングに使えるような横断的な感心事である場合にはヘッダーにいれるのが適切だと個人的には思いました。

## まとめ

HTTPヘッダーについて改めて深掘りしてみました。普段何気なく使っているヘッダーですが、その背景にはヘッダーだけで判断できるものはそれだけで判断するなどの役割があると改めて理解しました。

今回は簡単な記事になりましたが、とりあえずやたらめったらヘッダーに詰めるのは性能観点でもよくなさそうだなということが理解できました。最後まで読んでいただき、ありがとうございました🙏
